                        ...
                        <table class="table table-striped table-bordered" style="white-space: nowrap;">
                            ...
                            <tbody>
                                ...
                                while ($data_adv = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "  <td>
                                            <a class='btn btn-sm btn-primary' data-toggle='tooltip' data-placement='top' title='Editar' href='advogados_edit.php?id=$data_adv[idusuario]'>
                                                <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pen-fill' viewBox='0 0 16 16'>
                                                    <path d='m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001z'/>
                                                </svg>
                                            </a>
                                            <a class='btn btn-light' data-toggle='tooltip' data-placement='top' title='Ver processos' href='../../Processos/processos.php?statusfiltro=Todos&buscanome=&termobusca=&advogado=$data_adv[nome]' style='padding: 2%; width: 30%;'>
                                                <i class='fa-solid fa-scale-balanced' width='16' height='16'></i>
                                            </a>
                                            <a class='btn btn-sm btn-danger' data-toggle='tooltip' data-placement='top' title='Excluir' href='advogados_delete.php?id=$data_adv[idusuario]' onclick='return confirma($data_adv[idusuario])'>
...
<script>
    function confirma(id) {
        if (confirm("Deseja realmente excluir este advogado?")) {
            location.href = "advogados_delete.php?id=" + id;
        } else {
            return false;
        }
    }
