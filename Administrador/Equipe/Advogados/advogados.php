                            ...
                            <tbody>
                                ...
                                while ($data_adv = mysqli_fetch_assoc($result)) {
                                    ...
                                    echo "  <td>
                                            ...
                                            <a class='btn btn-light' href='../../Processos/processos.php?statusfiltro=Todos&buscanome=&termobusca=&advogado=$data_adv[nome]' style='padding: 2%; width: 30%;'>
                                                <i class='fa-solid fa-scale-balanced' width='16' height='16'></i>
                                            </a>
                                            <a class='btn btn-sm btn-danger' href='advogados_delete.php?id=$data_adv[idusuario]' onclick='return confirma($data_adv[idusuario])'>
