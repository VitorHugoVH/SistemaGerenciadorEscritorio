        ...
        <form action="compromissos_save.php" method="POST">
            ...
            <div class="bloco4">
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-3">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Data Incial</h6></b></label>
                            <input type="date" name="datainicial" id="datainicial" class="form-control" aria-label="Default" value="<?php echo $dataincial ?>" required>
                        </div>
                        <div class="col-3">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Hora Incial</h6></b></label>
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-12">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Nome do compromisso</h6></b></label>
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-12">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Classificação</h6></b></label>
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-12">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Local</h6></b></label>
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-12">
                            <label for="exampleFormControlTextarea1"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Observações</h6></b></label>
                ...
                <div class="campos">
                    <div class="row">
                        <div class="col-12">
                            <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Cliente</h6></b></label>
