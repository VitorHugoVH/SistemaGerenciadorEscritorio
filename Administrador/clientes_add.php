                ...
                <form action="clientes_insert.php" method="POST">
                    ...
                    <div class="bloco4">
                        <div class="row">
                            ...
                            <div class="campos">
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        ...
                                        <!-- Javascript--->
                                        <input type="hidden" name="numerocnpj" id="numerocnpj" class="form-control" placeholder="Número do CNPJ" maxlength="11" oninput="mascara(this)">
                                        <!-- Javascript--->
                                    </div>
                                    <script>
                                        function mascara(i) {
                            ...
                            <div id="campos5" style="  margin-top: 0%; margin-bottom: 2%; display:block;">
                                ...
                                <input type="text" name="numerorg" id="numerorg" class="form-control" placeholder="Número do RG">
                            </div>
                            <!-- Javascript--->
                            ...
                            <div id="segundacampos5" style="display: none; margin-top: 0%; margin-bottom: 2%;">
                                ...
                                <input type="text" name="atividadeprincipal" id="atividadeprincipal" class="form-control" placeholder="Atividade principal">
                            </div>
                            <!-- Javascript--->
                            ...
                            <div class="campos">
                                ...
                                <textarea name="observacoes" id="observacoes" col="3" class="form-control" placeholder="Observação"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="bloco5">
                    ...
                    <div class="final">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div id="voltar">
                                    <a href="clientes_insert.php"><button type="submit" class="btn btn-success" name="enviar" id="salvar">Salvar</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
