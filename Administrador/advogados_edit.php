<?php
    ...
    if(!empty($_GET['id'])){
        ...
        while($data = mysqli_fetch_assoc($result)){
            ...
            $nomeadvogado = $data['nome'];
            $funcao = $data['funcao'];
            $numerooab = $data['oab'];
            $estadooab = $data['estadooab'];
            $cpf = $data['cpf'];
            $sexo = $data['sexo'];
            ...
            $tipocontato1 = $data['tipocontato1'];
            $ddi1 = $data['ddi1'];
            $ddd1 = $data['ddd1'];
...
<body>
    ...
    <div class="container" id='main'>
        <form action="advogados_save.php" method="POST">
            <div class="row">
                <div class="col-10">
                    <div class="bloco3">
            ...
            <div class="bloco4">
                <div class="row">
                    ...
                    <div class="campos">
                        <label for="nomeadvogado"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Nome completo</h6></b></label>
                        <input type="text" name="nomeadvogado" id="nomeadvogado" placeholder="Nome completo" class="form-control" value="<?php echo $nomeadvogado; ?>">
                    </div>
                    <div class="campos">
                        <label for="funcao"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Função</h6></b></label>
                        <select class="form-select" name="funcao" id="funcao" onchange="fun()">
                            <option value="Não selecionado" <?= ($funcao == 'Não selecionado')?'selected':' '?>>Selecione</option>
                            <option <?= ($funcao == 'Advogado')?'selected':' '?>>Advogado</option>
                            <option <?= ($funcao == 'Assistente juridico')?'selected':' '?>>Assistente juridico</option>
                            <option <?= ($funcao == 'Auditor')?'selected':' '?>>Auditor</option>
                            <option <?= ($funcao == 'Bacharel em direito')?'selected':' '?>>Bacharel em direito</option>
                            <option <?= ($funcao == 'Diretoria de operações')?'selected':' '?>>Diretoria de operações</option>
                            <option <?= ($funcao == 'Estagiário')?'selected':' '?>>Estagiário</option>
                            <option <?= ($funcao == 'Paralegal')?'selected':' '?>>Paralegal</option>
                            <option <?= ($funcao == 'Perito')?'selected':' '?>>Perito</option>
                            <option <?= ($funcao == 'Recepção')?'selected':' '?>>Recepção</option>
                            <option <?= ($funcao == 'Secretário')?'selected':' '?>>Secretário</option>
                            <option <?= ($funcao == 'Sócio fundador')?'selected':' '?>>Sócio fundador</option>
                        </select>
                    </div>
                        <div id="OAB" style="margin-top: 2%; margin-bottom: 2%; display: none;">
                            <label for="numerooab"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número da OAB</h6></b></label>
                            <input type="text" name="numerooab" id="numerooab" class="form-control" placeholder="Número da OAB" value="<?php echo $numerooab; ?>">
                        </div>
                        <div id="UF" style="margin-top: 2%; margin-bottom: 2%; display: none;">
                            <label for="estadooab"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Estado da OAB</h6></b></label>
                            <select id="estadooab" name="estadooab" class="form-select">
                                <option <?= ($funcao == 'Selecione')?'select':' '?>>Selecione</option>
                                <option <?= ($funcao == 'AC')?'selected':' '?>>AC</option>
                                <option <?= ($funcao == 'AL')?'selected':' '?>>AL</option>
                                <option <?= ($funcao == 'AP')?'selected':' '?>>AP</option>
                                <option <?= ($funcao == 'AM')?'selected':' '?>>AM</option>
                                <option <?= ($funcao == 'BA')?'selected':' '?>>BA</option>
                                <option <?= ($funcao == 'CE')?'selected':' '?>>CE</option>
                                <option <?= ($funcao == 'DF')?'selected':' '?>>DF</option>
                                <option <?= ($funcao == 'ES')?'selected':' '?>>ES</option>
                                <option <?= ($funcao == 'GO')?'selected':' '?>>GO</option>
                                <option <?= ($funcao == 'MA')?'selected':' '?>>MA</option>
                                <option <?= ($funcao == 'MS')?'selected':' '?>>MS</option>
                                <option <?= ($funcao == 'MT')?'selected':' '?>>MT</option>
                                <option <?= ($funcao == 'MG')?'selected':' '?>>MG</option>
                                <option <?= ($funcao == 'PA')?'selected':' '?>>PA</option>
                                <option <?= ($funcao == 'PB')?'selected':' '?>>PB</option>
                                <option <?= ($funcao == 'PR')?'selected':' '?>>PR</option>
                                <option <?= ($funcao == 'PE')?'selected':' '?>>PE</option>
                                <option <?= ($funcao == 'PI')?'selected':' '?>>PI</option>
                                <option <?= ($funcao == 'RJ')?'selected':' '?>>RJ</option>
                                <option <?= ($funcao == 'RN')?'selected':' '?>>RN</option>
                                <option <?= ($funcao == 'RS')?'selected':' '?>>RS</option>
                                <option <?= ($funcao == 'RO')?'selected':' '?>>RO</option>
                                <option <?= ($funcao == 'RR')?'selected':' '?>>RR</option>
                                <option <?= ($funcao == 'SC')?'selected':' '?>>SC</option>
                                <option <?= ($funcao == 'SP')?'selected':' '?>>SP</option>
                                <option <?= ($funcao == 'SE')?'selected':' '?>>SE</option>
                                <option <?= ($funcao == 'TO')?'selected':' '?>>TO</option>
                            </select>
                        </div>
                    <script>
                    function fun(){
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">CPF</h6></b></label>
                        <input type="text" name="numerocpf" id="numerocpf" class="form-control" placeholder="Número do CPF" maxlength="11" oninput="mascara(this)" value="<?php echo $cpf; ?>">
                        <script>
                                function mascara(i){
                    ...
                    <div class="campos">
                        <label for="sexo"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Sexo</h6></b></label>
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Data de nascimento</h6></b></label>
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">RG</h6></b></label>
                        <input type="number" name="numerorg" id="numerorg" placeholder="Número do RG" class="form-control" value="<?php echo $rg; ?>">
                    </div>
                    <div class="campos">
                        <label for="estadocivil"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Estado civil</h6></b></label>
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Profissão</h6></b></label>
                        <input type="text" name="profissao" id="profissao" class="form-control" placeholder="Profissão" value="<?php echo $profissao; ?>">
                    </div>
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Outros documentos e observações</h6></b></label>
                        <textarea class="form-control" col="1" rows="8" name="descricao" id="descricao" placeholder="Observações"><?php echo $observacoes; ?></textarea>
                    </div>
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Status do usuario</h6></b></label>
            ...
            <div class="bloco5">
                <div class="row">
                    ...
                    <div class="campos">
                        <div class="row">
                            <div class="col-3">
                                <label for="tipocontato"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Tipo contato</h6></b></label>   
                                <select class="form-select" name="tipocontato" id="tipocontato">
                                    <option <?= ($tipocontato1 == 'Telefone')?'selected':' '?>>Telefone</option>
                                    <option <?= ($tipocontato1 == 'Fax')?'selected':' '?>>Fax</option>
                                    <option <?= ($tipocontato1 == 'Celular')?'selected':' '?>>Celular</option>
                                    <option <?= ($tipocontato1 == 'Residencial')?'selected':' '?>>Residencial</option>
                                    <option <?= ($tipocontato1 == 'Comercial')?'selected':' '?>>Comercial</option>
                                    <option <?= ($tipocontato1 == 'Nextel')?'selected':' '?>>Nextel</option>
                                </select>
                            </div>
                            <div class="col-2">
                                <label for="ddi"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDI</h6></b></label>   
                                <input type="number" name="ddi" id="ddi" class="form-control" maxlength="2" placeholder="55" value="<?php echo $ddi1; ?>">
                            </div>
                            <div class="col-2">
                                <label for="ddd"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDD</h6></b></label>   
                                <input type="number" name="ddd" id="ddd" class="form-control" maxlength="2" placeholder="DDD" value="<?php echo $ddd1; ?>">
                            </div>
                            <div class="col-5">
                                <label for="numero"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número</h6></b></label>   
                        ...
                        <div id="telefone2" style="  margin-top: 2%; margin-bottom: 2%; display: none;">
                            <div class="row">
                                <div class="col-3">
                                    <label for="tipocontato2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Tipo contato</h6></b></label>   
                                ...
                                <div class="col-2">
                                    <label for="ddi2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDI</h6></b></label>   
                                    <input type="number" name="ddi2" id="ddi2" class="form-control" maxlength="2" placeholder="55" value="<?php echo $ddi2; ?>">
                                </div>
                                <div class="col-2">
                                    <label for="ddd2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDD</h6></b></label>   
                                    <input type="number" name="ddd2" id="ddd2" class="form-control" maxlength="2" placeholder="DDD" value="<?php echo $ddd2; ?>">
                                </div>
                                <div class="col-5">
                                    <label for="numero2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número</h6></b></label>   
                        ...
                        <div id="telefone3" style="  margin-top: 2%; margin-bottom: 2%; display: none;">
                            <div class="row">
                                <div class="col-3">
                                    <label for="tipocontato3"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Tipo contato</h6></b></label>   
                                ...
                                <div class="col-2">
                                    <label for="ddi3"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDI</h6></b></label>   
                                    <input type="number" name="ddi3" id="ddi3" class="form-control" maxlength="2" placeholder="55" value="<?php echo $ddi3; ?>">
                                </div>
                                <div class="col-2">
                                    <label for="ddd3"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">DDD</h6></b></label>   
                                    <input type="number" name="ddd3" id="ddd3" class="form-control" maxlength="2" placeholder="DDD" value="<?php echo $ddd3; ?>">
                                </div>
                                <div class="col-5">
                                    <label for="numero3"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número</h6></b></label>   
            ...
            <div class="bloco5">
                ...
                <div class="campos">
                    <label for="cep"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">CEP</h6></b></label>   
                    <input type="text" name="cep" id="cep" class="form-control" placeholder="CEP" maxlength="8" value="<?php echo $cep1 ?>">
                </div>
                <div class="campos">
                    <div class="row">
                        <div class="col-9">
                            <label for="endereco"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Endereço</h6></b></label>   
                            <input type="text" name="endereco" id="endereco" class="form-control" placeholder="Endereço" value="<?php echo $endereco1 ?>">
                        </div>
                        <div class="col-3">
                            <label for="numerocasa"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número</h6></b></label>   
                            <input type="text" name="numerocasa" id="numerocasa" class="form-control" placeholder="Número" value="<?php echo $numerocasa1 ?>">
                        </div>
                    </div>  
                </div>
                <div class="campos">
                    <label for="complemento"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Complemento</h6></b></label>   
                    <input type="text" name="complemento" id="complemento" class="form-control" placeholder="Complemento" value="<?php echo $complemento1 ?>">
                </div>
                <div class="campos">
                    <div class="row">
                        <div class="col-4">
                            <label for="bairro"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Bairro</h6></b></label>   
                            <input type="text" name="bairro" id="bairro" class="form-control" placeholder="Bairro" value="<?php echo $bairro1 ?>">
                        </div>
                        <div class="col-4">
                            <label for="cidade"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Cidade</h6></b></label>   
                            <input type="text" name="cidade" id="cidade" class="form-control" placeholder="Cidade" value="<?php echo $cidade1 ?>">
                        </div>
                        <div class="col-4">
                            <label for="estado"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Estado</h6></b></label>   
                            <select class="form-select" id="estado" name="estado">
                                <option value="Não selecinado" <?= ($estado1 == 'Não selecinado')?'selected':' '?>>Selecione</option>
            ...
            <div id="addendereco" style="background-color: #fcfcfc; padding: 2%; margin-top: 5%; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; display: none;">
                ...
                <div class="campos">
                    <label for="cep2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">CEP</h6></b></label>   
                    <input type="text" name="cep2" id="cep2" class="form-control" placeholder="CEP" maxlength="8" value="<?php echo $cep2; ?>">
                </div>
                <div class="campos">
                    <div class="row">
                        <div class="col-9">
                            <label for="endereco2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Endereço</h6></b></label>   
                            <input type="text" name="endereco2" id="endereco2" class="form-control" placeholder="Endereço" value="<?php echo $endereco2; ?>">
                        </div>
                        <div class="col-3">
                            <label for="numerocasa2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Número</h6></b></label>   
                            <input type="text" name="numerocasa2" id="numerocasa2" class="form-control" placeholder="Número" value="<?php echo $numerocasa2; ?>">
                        </div>
                    </div>  
                </div>
                <div class="campos">
                    <label for="complemento2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Complemento</h6></b></label>   
                    <input type="text" name="complemento2" id="complemento2" class="form-control" placeholder="Complemento" value="<?php echo $complemento2; ?>">
                </div>
                <div class="campos">
                    <div class="row">
                        <div class="col-4">
                            <label for="bairro2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Bairro</h6></b></label>   
                            <input type="text" name="bairro2" id="bairro2" class="form-control" placeholder="Bairro" value="<?php echo $bairro2; ?>">
                        </div>
                        <div class="col-4">
                            <label for="cidade2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Cidade</h6></b></label>   
                            <input type="text" name="cidade2" id="cidade2" class="form-control" placeholder="Cidade" value="<?php echo $cidade2; ?>">
                        </div>
                        <div class="col-4">
                            <label for="estado2"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Estado</h6></b></label>   
                            <select class="form-select" id="estado2" name="estado2">
                            <option <?= ($estado2 == 'Selecione')?'selected':' '?>>Selecione</option>
            ...
            <div class="bloco5">
                ...
                <div class="campos">
                    <label for="login"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Login</h6></b></label>   
                    <input type="text" name="login" id="login" class="form-control" placeholder="Login" value="<?php echo $login ?>">
                </div>
                <div class="campos">
                    <label for="senha"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Senha</h6></b></label>
                    <div class="input-group">
            ...
            <div class="row">
                ...
                <div class="col-2">
                    <div id="voltar">
                        <a href="advogados_save.php"><button type="submit" class="btn btn-success" name="enviar" id="salvar">Salvar</button></a>
                    </div>
                </div>
            </div>
            </div>
