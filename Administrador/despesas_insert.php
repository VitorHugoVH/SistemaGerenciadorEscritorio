<?php
    ...
    if(isset($_POST['salvar'])){
        ...
        if(!empty($vencimento)){
            $vencimento2 = date('d/m/Y', strtotime($vencimento));
        }
        ...
        VALUES ('$vencimento2', '$valor', '$categoria', '$categoria2', '$subcategoria', '$subcategoria2', '$observacoes', '$status', '$datapagamento', '$juros', '$total', '$repetir', '$parcelas', '$anexo', '$datacriacao')";
