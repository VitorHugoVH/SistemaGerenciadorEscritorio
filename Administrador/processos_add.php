                ...
                <form action="" method="POST">
                    ...
                    <div class="bloco4">
                        <div class="row">
                            ...
                            <div id="falecidoarea" style="  margin-top: 1%; margin-bottom: 2%; display: none;">
                                ...
                                <input type="text" name="nomefalecido" id="nomefalecido" class="form-control" placeholder="Nome do falecido">
                            </div>
                            <script>
                                function nfalecido() {
                            ...
                            <div class="campos">
                                ...
                                <input type="number" name="valorcausa" id="valorcausa" step="0.01" min="0.01" class="form-control" placeholder="0.00">
                            </div>
                            <div class="campos">
                    ...
                    <div class="final">
                        <div class="row">
                            ...
                            <div class="col-2">
                                <div id="voltar">
                                    <a href="processos.php"><button type="submit" class="btn btn-success" name="enviar" id='salvar'>Salvar</button></a>
                                </div>
                            </div>
                        </div>
                    </div>
