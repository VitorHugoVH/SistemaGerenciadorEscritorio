        ...
        <form action="despesas_insert.php" method="POST">
            ...
            <div class="bloco4">
                <div class="row">
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Data vencimento</h6></b></label>
                        <input type="date" name="vencimento" id="vencimento" class="form-control">
                    </div>
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Valor</h6></b></label>
                        <input type="number" name="valor" id="valor" placeholder="0,00" class="form-control" required>
                    </div>
                    <div class="campos">
                        <div class="row">
                            <label for="categoria"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Categoria</h6></b></label>   
                            <div class="col-10">
                    ...
                    <div class="campos">
                        <div class="row">
                            <label for="subcategoria3"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Subcategoria</h6></b></label>   
                            <div class="col-10">
                    ...
                    <div class="campos">
                        <label for="desctarefa"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Observação</h6></b></label>   
                    ...
                    <div class="campos">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Situação</h6></b></label>   
                    ...
                    <div id="campos3" style="margin-top: 2%; margin-bottom: 2%; display: none;">
                        <label for="datapagamento"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Data do pagamento</h6></b></label>   
                    ...
                    <div class="campos">
                        <label for="total"><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Total</h6></b></label>   
                    ...
                    <div id="campos2" style="margin-top: 2%; margin-bottom: 2%; display: none;">
                        <label><b><h6 style="font-family: arial, sans-serif; font-size: 16px;">Nº de parcelas:</h6></b></label>   
